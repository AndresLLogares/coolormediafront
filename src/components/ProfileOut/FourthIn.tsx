...
import { GETUSERUUID, GETUSER, GETPOSTBYUUID } from "../../redux/actions";
import { URL } from "../../utils/url";
import toast from "react-hot-toast";
import axios from "axios";
import { Like } from "@styled-icons/boxicons-solid/Like";
import PopUpComment from "../ProfileIn/PopUpComment";
import { getTime } from "../ProfileIn/GetTime";
import styles from "../Title/title.module.scss";

export default function Fourth(props: any): JSX.Element {
  ...
  let posts = user?.coolor?.postuuid?.posts;
  ...
  return (
    <div className={classes.root}>
      ...
      <div className={classes.boxPosts}>
        {popUp ? (
          <PopUpComment idComment={idComment} setPopUp={setPopUp} uuid={UUID} />
        ) : null}
        {posts?.map((post: any) => {
          return (
